...
The Open Meta Project is a collaborative effort to produce a website where scientists can conduct, comment on, and share meta-analyses. We are in the early stages of the project, so please let us know if you would like to contribute (baptistajohann@gmail.com).
